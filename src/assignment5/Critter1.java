...
public class Critter1 extends Critter.TestCritter{
    ...
    public static String runStats(java.util.List<Critter> gymRat) {
        ...
        String s = "";
        s += gymRat.size() + " total GymRats    ";
        s+= total_straight / (GENE_TOTAL * 0.01 * gymRat.size()) + "% straight   ";
        s += total_back / (GENE_TOTAL * 0.01 * gymRat.size()) + "% back   ";
        s += total_right / (GENE_TOTAL * 0.01 * gymRat.size()) + "% right   ";
        s += total_left / (GENE_TOTAL * 0.01 * gymRat.size()) + "% left   ";
